...
handler.all = async function (m) {
  ...
  let fotonyu = "https://files.catbox.moe/k04xjg.webp";
  let logo = "https://files.catbox.moe/k04xjg.webp"; // define logo aquí
  let namebot = "SISIA BOT AI";
  let sig = "https://instagram.com/nafis.ali9";
  ...
  try {
    ...
    global.emror = "https://files.catbox.moe/k04xjg.webp";
    ...
    global.kontak2 = [
      [
        owner[0],
        await conn.getName(owner[0] + "212719558797@s.whatsapp.net"),
        "SILANA AI",
        "https://whatsapp.com",
        true,
      ],
